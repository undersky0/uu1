...
class User < ActiveRecord::Base
  ...
  devise *SocialStream.devise_modules #uses device gem for authentication
  ...
  # Setup accessible (or protected) attributes for your model - the list of attributes for user model.
  # Post code, required.
